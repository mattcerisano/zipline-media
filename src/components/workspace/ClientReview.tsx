  ...
  return (
    <div className="flex h-full bg-neutral-950 text-white overflow-hidden">
      ...
      <div className="w-80 border-r border-white/10 bg-zinc-900/30 flex flex-col h-full shrink-0">
                ...
                >
                  <div className="flex items-start justify-between gap-2">
                    <div className="min-w-0">
                      ...
                      <span className="text-[8px] font-black uppercase bg-white/5 border border-white/5 text-white/50 px-2 py-0.5 rounded-full mt-1 inline-block">
                  ...
                  <div className="flex items-center justify-between text-[9px] font-bold text-white/30 uppercase tracking-wider border-t border-white/5 pt-2 mt-1">
        ...
        <div className="p-3 bg-black/40 border-t border-white/10 flex items-center gap-1.5 text-[9px] font-black uppercase tracking-widest text-white/40">
                      ...
                      <div className="flex justify-between items-start mb-2">
                        <div>
                          ...
                          <span 
                            ...
                            className="inline-flex items-center gap-1.5 mt-1 px-2 py-0.5 rounded bg-yellow-500/10 border border-yellow-500/20 text-[9px] font-mono font-bold text-yellow-400 hover:bg-yellow-500 hover:text-black transition-all"
                          >

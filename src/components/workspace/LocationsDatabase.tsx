              ...
              >
                ...
                <div className="space-y-3 flex-1">
                  ...
                  <div className="flex gap-2.5 items-start">
                    ...
                    <div>
                      <p className="text-[9px] font-black uppercase tracking-wider text-white/30">Permits & Clearances</p>
                  ...
                  <div className="flex gap-2.5 items-start">
                    ...
                    <div>
                      <p className="text-[9px] font-black uppercase tracking-wider text-white/30">Power Grid Specs</p>
                  ...
                  <div className="flex gap-2.5 items-start">
                    ...
                    <div>
                      <p className="text-[9px] font-black uppercase tracking-wider text-white/30">Parking Capacity</p>
                ...
                <div className="border-t border-white/5 pt-4 flex justify-end">
                  <button
                    ...
                    className="p-2 bg-red-500/5 hover:bg-red-500/15 border border-red-500/10 hover:border-red-500/20 rounded-xl text-red-400/60 hover:text-red-400 opacity-0 group-hover:opacity-100 transition-all cursor-pointer flex items-center gap-1.5 text-[9px] font-black uppercase tracking-widest"
                  >

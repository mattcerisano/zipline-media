...
export default function EquipmentPage() {
  ...
  // This page shows the exact same catalog the Command Center gear builder
  // writes to, so anything added there appears here. The bundled inventory file
  // is only a fallback for when the database is unreachable.
